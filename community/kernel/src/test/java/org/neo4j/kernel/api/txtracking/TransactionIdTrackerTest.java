...
{
    private final static Duration DEFAULT_DURATION = ofSeconds( 10 );
    ...
    public void setup()
    {
        ...
        transactionIdTracker = new TransactionIdTracker( () -> transactionIdStore, availabilityGuard, Clock.systemUTC() );
    }
