...
{
    private static final int RECONNECT_TIME_MS = 1_000;
    ...
    SimpleDiscoveryClient( AdvertisedSocketAddress address, LogProvider logProvider, DiscoveryGossip firstGossip )
    {
        ...
        this.bootstrap = new Bootstrap()
                ...
                .handler( new ChannelInitializer<NioDatagramChannel>()
                {
                    ...
                    {
                        ch.pipeline().addLast( "gossip-encoder", new DiscoveryGossipEncoder() );
    ...
    {
        eventLoopGroup.schedule( this::connect, delayMillis, TimeUnit.MILLISECONDS );
    }
