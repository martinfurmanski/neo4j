...
public class ReplicatedLockTokenRequest<MEMBER> implements CoreReplicatedContent, LockToken
{
    ...
    @Override
    public void dispatch( CoreStateMachines coreStateMachines, long commandIndex, Consumer<Result> consumer )
    {
        coreStateMachines.dispatch( this, commandIndex, consumer );
    }
}
