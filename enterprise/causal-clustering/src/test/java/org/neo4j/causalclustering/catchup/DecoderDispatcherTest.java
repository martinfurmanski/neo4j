...
public class DecoderDispatcherTest
{
    ...
    {
        // given
        DecoderDispatcher<State> dispatcher = new DecoderDispatcher<>( protocol, logProvider );
    ...
    public void shouldLogAWarningIfThereIsNoDecoderForTheMessageType() throws Exception
    {
        ...
        AssertableLogProvider.LogMatcher matcher =
                inLog( DecoderDispatcher.class ).warn( "Unregistered handler for protocol %s", protocol );
