...
public class CoreChannelPoolTest
{
    @Test
    public void shouldReUseAChannelThatWasReleased() throws Exception
    {
        // given
        CoreChannelPool<TestChannel> pool = new CoreChannelPool<>( TestChannel::new );
    ...
    private static class TestChannel implements CoreChannelPool.Channel
    {
