...
{
    private ReplicatedLockToken currentToken = ReplicatedLockToken.INVALID_REPLICATED_LOCK_TOKEN;
    ...
    public ReplicatedLockTokenState( long ordinal, ReplicatedLockToken currentToken )
    {
        this.ordinal = ordinal;
        this.currentToken = currentToken;
    }

    public void set( ReplicatedLockToken currentToken, long ordinal )
    {
        this.currentToken = currentToken;
        this.ordinal = ordinal;
    }

    public ReplicatedLockToken get()
    {
        return currentToken;
    }
    ...
    public static class Marshal extends SafeStateMarshal<ReplicatedLockTokenState>
    {
        ...
        public ReplicatedLockTokenState unmarshal0( ReadableChannel channel ) throws IOException, EndOfStreamException
        {
            ...
            return new ReplicatedLockTokenState( logIndex, new ReplicatedLockToken( member, candidateId ) );
        }
