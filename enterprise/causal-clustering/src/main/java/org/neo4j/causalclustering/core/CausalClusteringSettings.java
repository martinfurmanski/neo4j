...
public class CausalClusteringSettings implements LoadableConfig
{
    ...
    public static Setting<InFlightCacheFactory.Type> in_flight_cache_type =
    ...
    public static Setting<Integer> in_flight_cache_max_entries =
    ...
    public static Setting<Long> in_flight_cache_max_bytes =
