...
public class StopSessionRequest implements CoreRequest
{
    private final GlobalSession session;

    StopSessionRequest( GlobalSession session )
    {
    ...
    {
        return RequestMessageType.STOP_LOCK_SESSION;
    }

    public static class Encoder extends MessageToByteEncoder<StopSessionRequest>
    {
        @Override
        protected void encode( ChannelHandlerContext ctx, StopSessionRequest msg, ByteBuf out ) throws Exception
        {
    ...
    public static class Decoder extends ByteToMessageDecoder
    {
        ...
        protected void decode( ChannelHandlerContext ctx, ByteBuf in, List<Object> out ) throws Exception
        {
            ...
            out.add( new StopSessionRequest( session ) );
        }
    }
}
