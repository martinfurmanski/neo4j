...
public class EndSessionRequest implements CoreRequest
{
    private final GlobalSession session;

    EndSessionRequest( GlobalSession session )
    {
    ...
    {
        return RequestMessageType.END_LOCK_SESSION;
    }

    public static class Encoder extends MessageToByteEncoder<EndSessionRequest>
    {
        @Override
        protected void encode( ChannelHandlerContext ctx, EndSessionRequest msg, ByteBuf out ) throws Exception
        {
    ...
    public static class Decoder extends ByteToMessageDecoder
    {
        ...
        protected void decode( ChannelHandlerContext ctx, ByteBuf in, List<Object> out ) throws Exception
        {
            ...
            out.add( new EndSessionRequest( session ) );
        }
    }
}
