...
public class ExclusiveMode extends Operations
{
    ExclusiveMode( Locks.Client client )
    {
        super( client );
    }
    ...
    {
        client.acquireExclusive( type, ids );
    }

    @Override
    public boolean tryAcquire( ResourceTypes type, long id )
    {
        return client.tryExclusiveLock( type, id );
    }

    @Override
    public void release( ResourceTypes type, long id )
    {
        client.releaseExclusive( type, id );
    }
}
