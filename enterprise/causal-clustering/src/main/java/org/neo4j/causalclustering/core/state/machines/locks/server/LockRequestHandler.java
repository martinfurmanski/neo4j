...
public interface LockRequestHandler
{
    void handle( ChannelHandlerContext ctx, CoreServerProtocol protocol, RegisterLockSessionRequest msg );

    void handle( ChannelHandlerContext ctx, CoreServerProtocol protocol, AcquireLocksRequest msg );

    void handle( ChannelHandlerContext ctx, CoreServerProtocol protocol, ReleaseLockRequest msg );

    void handle( ChannelHandlerContext ctx, CoreServerProtocol protocol, StopSessionRequest msg );

    void handle( ChannelHandlerContext ctx, CoreServerProtocol protocol, EndSessionRequest msg );
}
